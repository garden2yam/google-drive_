...
import DashbaordView from "./components/DashbaordView"
import DashbaordViewDetail from "./components/DashbaordViewDetail"
...
export default new Router({
    ...
    routes: [
            ...
            {
                path: '/dashbaords/:id',
                name: 'DashbaordViewDetail',
                component: DashbaordViewDetail
            },
            {
                path: '/files',
                name: 'FileManager',
